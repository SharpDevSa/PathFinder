...
{
    internal class BreadthFirstSearchOnTheCommand : ISearchCommand, IsValidCommandParametr
    {
        private BaseMapAnalizer MapAnalizer;
        private Node Start;
        private Node End;

        public BreadthFirstSearchOnTheCommand(BreadthFirstSearch search, Node start, Node end)
        {
            Start = start;
            End = end;
            MapAnalizer = search;
